...
//  {/* Move Total Table */}
//               {user.moveServices.moveCost.length !== 0 && (
//                 <>
//                   <br />
//                   <table id="move-total-table" border="1">
//                     <thead>
...
//                           Move charges based on{" "}
//                           {user.moveServices.moveCost.totalMen} men &{" "}
//                           {user.moveServices.moveCost.totalTrucks} truck(s)
//                           for {user.moveServices.moveCost.moveHours} hours @{" "}
...
//                 <thead>
//                   <tr>
//                     <th className="t-head">Understanding Your Estimate</th>
//                   </tr>
//                 </thead>
//                 <tbody className="padding-0">
//                   <tr className="padding-0">
//                     <td className="td-20">
//                       - Please be advised this is just an estiamate. The total
//                       charges for your move are based on actual moving time
//                       plus <br /> the travel. Packing materials are billed for
//                       an additional cost. All jobs are subject to a minimum
//                       charge of 1 <br /> hour. Please ask your sales person.{" "}
//                       <br /> - We will provide a blanket wrap service while we
//                       transport your items. <br /> - Full replacement value
//                       insurance is included in the cost. <br /> - The last
//                       hour is always prorated into 15 minute increments.{" "}
//                       <br /> - The FULL invoice for services is payable at the
//                       completion of the move by: Check, Cashier's Check, Money
//                       Order,
//                       <br /> Cash or Visa & Master Card with a 4%
//                       administration fee on cards. <br /> - Cancellation
//                       Policy: A 72 hour (3 Day) notice of cancellation is
